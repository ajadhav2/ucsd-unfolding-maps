...
//		ellipse(50, 225, 5, 5);
		...
		fill(244, 225, 83);
		ellipse(50, 327, 12, 12);
		fill(0, 0, 255);
		ellipse(50, 377, 12, 12);
		fill(255, 0, 0);
		ellipse(50, 427, 12, 12);
		
		fill(0, 0, 0);
		text("City Marker", 72, 127);
		text("Land Quake", 72, 177);
		text("Ocean Quake", 72, 227);
		text("Size ~ Magnitude", 72, 277);
		text("Shallow", 72, 327);
		text("Intermidiate", 72, 377);
		text("Deep", 72, 427);
	}
	...
	private void printQuakes() 
	{
		...
		for(Marker m : quakeMarkers) {
			...
			if(em.isOnLand()) {
				...
				String country = (String)m.getProperty("country");
//				System.out.println(" ccc " + country);
